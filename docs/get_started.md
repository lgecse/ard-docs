...
- **Join the community:** Browse the code and reference implementations on [GitHub](https://github.com/ards-project), propose schema changes, or [open an issue](https://github.com/ards-project/docs/issues). Feedback is welcome.
